...
import {CategoryController} from "../category/infrastructure/category.controller";
...
@Module({
  ...
  providers: [...categoryTypeUseCaseConfig, ...categoryTypeMappersConfig, ...categoryTypeRepositoryConfig, ...categoryTypeProviders],
